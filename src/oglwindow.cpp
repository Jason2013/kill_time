...
{
	COGLWindow *glWindow = (COGLWindow*)GetWindowLongPtr(hWnd, GWLP_USERDATA);
	...
	{	
		case WM_CREATE:			// window creation
		{
			...
			SetWindowLongPtr(hWnd, GWLP_USERDATA, (LONG)glWindow);
			glWindow->hWnd = hWnd;
...
{
	WNDCLASSEX windowClass;		// the window class
